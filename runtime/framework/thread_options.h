...
#ifndef THIRD_PARTY_LITERT_LM_RUNTIME_FRAMEWORK_THREAD_OPTIONS_H_
#define THIRD_PARTY_LITERT_LM_RUNTIME_FRAMEWORK_THREAD_OPTIONS_H_
...
#endif  // THIRD_PARTY_LITERT_LM_RUNTIME_FRAMEWORK_THREAD_OPTIONS_H_
