  ...
  describe('Wasm tests', () => {
    ...
    describe('EngineSettings', () => {
      ...
      it('creates EngineSettings', () => {
        const engineSettings =
            liteRtLm.liteRtLmWasm.EngineSettings.createDefault(
    ...
    describe('LlmExecutorSettings', () => {
      ...
      it('sets and gets sampler backend', () => {
        llmExecutorSettings.setSamplerBackend(
      ...
      it('sets and gets advanced settings', () => {
        ...
        expect(llmExecutorSettings.getAdvancedSettings())
            .toEqual(advancedSettings);
      });
    });
